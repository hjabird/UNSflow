...
include("lowOrder3D/BilinearQuadSurf.jl")
include("lowOrder3D/LatticeQuadSurf.jl")
include("lowOrder3D/UnstructuredMesh.jl")
include("lowOrder3D/MeshDataLinker.jl")
...
include("lowOrder3D/FreeStream3D.jl")
include("lowOrder3D/Vorticity3DProxy.jl")
include("lowOrder3D/LinkedVorticity3DChild.jl")
include("lowOrder3D/LinkedVorticity3DParent.jl")
...
include("lowOrder3D/VortexRingLattice.jl")
...
include("lowOrder3D/NeumannProblem3D.jl")
include("lowOrder3D/VortexLatticeMethod.jl")
